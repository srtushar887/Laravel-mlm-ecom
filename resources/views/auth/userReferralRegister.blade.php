            ...
            <div class="sign-in-page ">
                <div class="row ">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 sign-in">
                        ...
                        <form class="register-form outer-top-xs" role="form" action="{{route('user.referral.register.save')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">Referral ID<span>*</span></label>
                                <input type="text" name="have_ref_id" value="{{$ref_id}}" readonly class="form-control unicase-form-control text-input" id="exampleInputEmail1" required>
                            </div>
                            <div class="form-group">
