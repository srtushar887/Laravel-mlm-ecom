            ...
            <div class="sign-in-page ">
                <div class="row ">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 sign-in">
                        ...
                        <form class="register-form outer-top-xs" role="form" action="{{route('user.reset.changePassword.submit')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">New Password <span>*</span></label>
                                <input type="password" name="new_password" class="form-control unicase-form-control text-input" id="exampleInputEmail1" required>
                                <input type="hidden" name="u_id" value="{{$user_id}}" class="form-control unicase-form-control text-input" id="exampleInputEmail1" required>
                            </div>
                            <div class="form-group">
